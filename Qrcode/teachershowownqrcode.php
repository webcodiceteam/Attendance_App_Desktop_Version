            ...
            <div class="row">
                <div class="col-lg-12 logg">
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        <a class="ahref" href="../Teacher/welcometeacher.php">Home</a>
                        <a class="ahref" href="../Teacher/profilepageteacher.php">Profile</a>
                        <a class="ahref" href="../Qrcode/index.php">Qr Code Generated </a>
                        <a class="ahref" href="../Teacher/viewstudent.php">View All Student</a>
                        <a class="ahref" href="#">View All Qrcode</a>
...
$sql = "SELECT * FROM  qrcodes where teacher = '$new'";
